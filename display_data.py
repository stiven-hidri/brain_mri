...
def plot(stuff, subject_id, course):
    ...
    plt.savefig(os.path.join(os.curdir, 'display', "img", f"{subject_id}_{course}.png"))
...
if __name__ == "__main__":
    path_to_data_folder = os.path.join("display", "data") 
    
    clear_directory_content(os.path.join('display', 'img'))
